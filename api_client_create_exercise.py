...
from clients.users.public_users_client import get_public_users_client, CreatePublicUserRequestDict
from tools.fakers import get_random_email

public_users_client = get_public_users_client()

create_user_request = CreatePublicUserRequestDict(
...
create_file_request = CreateFileRequestDict(filename='image.png', directory='courses',
