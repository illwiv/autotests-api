...
@allure.feature("Check that response status code equals {expected}")
...
@allure.feature("Check that {name} equals to {expected}")
...
@allure.feature("Check that {name} is true")
...
def assert_length(actual: Sized, expected: Sized, name: str):
    ...
    with allure.step(f"Check that length of {name} equal to {len(expected)}"):
